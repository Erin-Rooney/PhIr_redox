...
Fe2_dat %>% 
  ggplot() +
  geom_point(aes(x = Fe2totalratio, y = depth_cm, color = month2), size = 2.5, alpha = 0.75)+
  geom_line(aes(x = Fe2totalratio, y = depth_cm, color = month2, group = grouping), orientation = "y", size = 0.75, linetype = "dotted")+
