...
combo_redox_withdepths = read.csv("processed/all_combine_2022.csv")
...
ggsave("formanuscript/2022redox_temporal_fig_2.png", plot = redox_temporal_fig_2_a, height = 10, width = 10)
